...
**[v1.0.5](https://github.com/stoatworks-labs/orrery/releases/tag/v1.0.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`orrery-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/orrery/releases/download/v1.0.5/orrery-1.0.5-macos-universal.dmg) | 413 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`orrery-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/orrery/releases/download/v1.0.5/orrery-1.0.5-windows-x86_64-setup.exe) | 227 KB |
