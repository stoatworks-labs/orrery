...
**[v1.0.6](https://github.com/stoatworks-labs/orrery/releases/tag/v1.0.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`orrery-1.0.6-macos-universal.dmg`](https://github.com/stoatworks-labs/orrery/releases/download/v1.0.6/orrery-1.0.6-macos-universal.dmg) | 414 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`orrery-1.0.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/orrery/releases/download/v1.0.6/orrery-1.0.6-windows-x86_64-setup.exe) | 227 KB |
