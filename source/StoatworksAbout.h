/*
 * Stoatworks Labs - About window data for Orrery.
 *
...
{
    inline constexpr auto name = "Orrery";
    inline constexpr auto slug = "orrery";
    inline constexpr auto hook = "Animated shapes for masks and pixel maps";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/orrery/guide/";
